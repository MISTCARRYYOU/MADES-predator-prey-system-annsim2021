...
from BDIAGENT.ACNetwork import *
# 两个被调用的结构体
# overall struct
# 由goal模块初始化并传递下去
class overallParameters:
    ...
    def __init__(self, args, agent_id_num):
        ...
        self.agent_policy = MADDPG(args, agent_id_num)  # 策略

        # 与环境交互获得的变量
        self.s = None
        self.r = None
        self.transitions = None
        self.other_agents_policy = None

        # 选择动作的变量
        self.chosen_actions = None

        # 用于判断训练过程收集buffer是否结束
        self.is_collect_over = False
